...
** DONE General
*** DONE args.rs
**** DONE Update Args struct if core argument
**** DONE Update OptionArgs struct
**** DONE Update Args resolve() if extra logic necessary
**** DONE Update Args fmt::Display if core argument
** DONE CLI arguments
*** DONE command.rs
**** DONE Update clap command definition
*** DONE cli.rs
**** DONE Update get_cli_args() and add extra logic if needed
** DONE Config arguments
*** DONE config.rs
**** DONE Update get_config_args()
** DONE Fix compiler warnings
** DONE Implement behaviour
** TODO Add tests
** TODO Update README
*** TODO CLI options
*** TODO Config options
*** TODO Usage section if commonly used option
