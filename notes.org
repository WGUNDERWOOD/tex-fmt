#+title: tex-fmt
* Tasks
** TODO Implement automatic line breaking in tables
** TODO Handle verbatim material inside tables
** TODO Ignore \makecell command contents in tables
** TODO Handle \multicolumn material in tables
* Release process
...
** Update Rust version
*** just upgrade
*** Update bindgen in CI GitHub action file
** Run tests
*** just
*** just perf
