...
complete -c tex-fmt -l wrap-by-visual-len -d 'Use visual length instead of character count when wrapping'
complete -c tex-fmt -l wrap-cjk -d 'Allow wrap at CJK characters'
