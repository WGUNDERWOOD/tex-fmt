...
% Input roman characters
% ：Solution to Cauchy equation
% How to reference problems?
...
\begin{proof}
    ...
    \end{align*}
\end{proof}
% I want to add a matrix here to illustrate the proof
